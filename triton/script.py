...
from src.models.loss_function.lovasz_loss import LovaszLoss, SBCE_Lovasz
from src.models.unet.components.unet import UNet
from src.models.unet.components.unet34 import Unet34

from src.models.unet.components.large_resnet_unet import LargeResNetUNet
...
def main():
    ...
    model = UNetLitModule.load_from_checkpoint(
        "checkpoints/unet34_lovasz_768.ckpt",
        net=Unet34(),
